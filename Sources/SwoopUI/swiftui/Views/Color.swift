...
extension Color {
    ...
    public static let gray = Color(rgba32: 0x808080FF)
    public static let black = Color(rgba32: 0x000000FF)
    public static let red = Color(rgba32: 0xFF0000FF)
    ...
    public static let purple = Color(rgba32: 0x800080FF)
    ...
    public static let orange = Color(rgba32: 0xffa500FF)
    ...
    public static let pink = Color(rgba32: 0xffc0cbFF)
